...
def fn_my_controller():
    ...
    while True:
        ...
        print("Found " + str(len(_founded_minima_list)) + "th minimum point====== (" + statement + str(
            minimum_value) + ")")
        new_region_list = []
        ...
        for i in range(_dimension):
            ...
            while True:
                left_zero_point_1 = fn_find_cutoffs(lower_upper_bound_list_left, str('left ' + str(i) + ' (' + str(count_left)))
