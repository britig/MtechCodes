...
def fn_my_controller():
    ...
    for i in range(0, 100):
        ...
        count_1 = 1
        while(True):
            left_zero_point = fn_find_cutoffs(left_zero_point[0], x1_minimum_point, left_zero_point[1], x2_minimum_point, str('left ('+str(count_1)))
        ...
        count_2 = 1
        while(True):
            right_zero_point = fn_find_cutoffs(x1_minimum_point, right_zero_point[0], x2_minimum_point, right_zero_point[1], str('right ('+str(count_2)))
